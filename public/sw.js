/*
 * BikeFit service worker (Flow 8, PRD §8): after the first load the app works
...
const FIT_SHELL = "/fit/offline-shell";
const PRECACHE = ["/", "/fit/new", "/fits", "/settings", "/method", FIT_SHELL];
